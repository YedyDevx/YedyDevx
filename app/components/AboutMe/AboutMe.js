...
const AboutMe = () => {
    return (
        <div className="bg-gradient-to-l from-[#0d0718] via-[#5a278e] to-[#0d0718]  w-[350px] sm:w-[600px] md:w-[700px] lg:w-[800px] xl:w-[1200px]  absolute  bottom-[0px] sm:bottom-[110px] md:bottom-[0px] rounded-2xl  z-40  mx-4 p-3 transition-all duration-300 shadow-[0_-15px_55px_-10px_#5a278e] ">
